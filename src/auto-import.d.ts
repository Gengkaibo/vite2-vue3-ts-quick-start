...
declare global {
  ...
  const useLayoutStore: typeof import('@/store/modules/layout')['useLayoutStore']
  const useLayoutStoreWithOut: typeof import('@/store/modules/layout')['useLayoutStoreWithOut']
  ...
  const useMenuStoreWithOut: typeof import('@/store/modules/menu')['useMenuStoreWithOut']
